...
private:
    ...
    //~ 结构体属性排序函数 (简化版本 - 不使用CustomThunk)
    // =================================================================================================

    /**
     * 按浮点属性排序结构体数组
     * 逻辑：提取属性值 → 排序索引 → 重排结构体数组
     */
    UFUNCTION(BlueprintCallable, Category = "XTools|排序|结构体",
        meta = (
            DisplayName = "结构体浮点属性排序",
            Keywords = "排序,结构体,浮点,属性",
            ToolTip = "按结构体的浮点类型属性进行排序"
        ))
    static TArray<int32> SortStructByProperty_Float(
        const TArray<int32>& StructArray,
        UPARAM(DisplayName="属性名称") FName PropertyName,
        UPARAM(DisplayName="升序排序") bool bAscending,
        UPARAM(DisplayName="原始索引") TArray<int32>& OriginalIndices);
    ...
    UFUNCTION(BlueprintCallable, Category = "XTools|排序|结构体",
        meta = (
            DisplayName = "结构体整数属性排序",
            Keywords = "排序,结构体,整数,属性",
            ToolTip = "按结构体的整数类型属性进行排序"
        ))
    static TArray<int32> SortStructByProperty_Int(
        const TArray<int32>& StructArray,
        UPARAM(DisplayName="属性名称") FName PropertyName,
        UPARAM(DisplayName="升序排序") bool bAscending,
        UPARAM(DisplayName="原始索引") TArray<int32>& OriginalIndices);
    ...
    UFUNCTION(BlueprintCallable, Category = "XTools|排序|结构体",
        meta = (
            DisplayName = "结构体字符串属性排序",
            Keywords = "排序,结构体,字符串,属性",
            ToolTip = "按结构体的字符串类型属性进行排序"
        ))
    static TArray<int32> SortStructByProperty_String(
        const TArray<int32>& StructArray,
        UPARAM(DisplayName="属性名称") FName PropertyName,
        UPARAM(DisplayName="升序排序") bool bAscending,
        UPARAM(DisplayName="原始索引") TArray<int32>& OriginalIndices);
    ...
    UFUNCTION(BlueprintCallable, Category = "XTools|排序|结构体",
        meta = (
            DisplayName = "结构体布尔属性排序",
            Keywords = "排序,结构体,布尔,属性",
            ToolTip = "按结构体的布尔类型属性进行排序"
        ))
    static TArray<int32> SortStructByProperty_Bool(
        const TArray<int32>& StructArray,
        UPARAM(DisplayName="属性名称") FName PropertyName,
        UPARAM(DisplayName="升序排序") bool bAscending,
        UPARAM(DisplayName="原始索引") TArray<int32>& OriginalIndices);
