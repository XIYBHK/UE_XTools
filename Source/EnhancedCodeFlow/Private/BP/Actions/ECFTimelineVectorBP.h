...
public:
	...
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true", WorldContext = "WorldContextObject", AdvancedDisplay = "Settings, BlendFunc, BlendExp", ToolTip = "添加一个在指定时间内在给定范围内运行的向量时间轴", DisplayName = "ECF - 向量时间轴"), Category = "XTools|ECF|时间轴")
