...
#include "K2Node.h"
#include "K2Node_MapRemoveMapItem.generated.h"
...
class UK2Node_MapRemoveMapItem : public UK2Node
{
    GENERATED_BODY()
...
#pragma region PinManagement
    ...
    UEdGraphPin* GetInputSubKeyPin() const;
...
private:
    ...
    static const FName InputSubKeyPinName;
