...
FText UK2Node_MapRemoveSetItem::GetNodeTitle(ENodeTitleType::Type TitleType) const
{
    return LOCTEXT("NodeTitle", "Map移除Set元素");
}

FText UK2Node_MapRemoveSetItem::GetCompactNodeTitle() const
{
    return LOCTEXT("CompactNodeTitle", "移除元素");
}

FText UK2Node_MapRemoveSetItem::GetTooltipText() const
{
    return LOCTEXT("TooltipText", "从Map中结构体值的Set字段移除元素");
}

FText UK2Node_MapRemoveSetItem::GetMenuCategory() const
{
    return LOCTEXT("MenuCategory", "XTools|Blueprint Extensions|Map");;
}

FSlateIcon UK2Node_MapRemoveSetItem::GetIconAndTint(FLinearColor& OutColor) const
{
    static FSlateIcon Icon("EditorStyle", "GraphEditor.MakeMap_16x");
    return Icon;
}

TSharedPtr<SWidget> UK2Node_MapRemoveSetItem::CreateNodeImage() const
{
...
class FKCHandler_MapRemoveSetItem : public FNodeHandlingFunctor
{

public:

	FKCHandler_MapRemoveSetItem(FKismetCompilerContext& InCompilerContext) 
    ...
    virtual void RegisterNets(FKismetFunctionContext& Context, UEdGraphNode* Node) override
	{
	    ...
	    UK2Node_MapRemoveSetItem* MapNode = CastChecked<UK2Node_MapRemoveSetItem>(Node);
    ...
    virtual void Compile(FKismetFunctionContext& Context, UEdGraphNode* Node) override
	{
	    ...
	    UFunction* RemoveSetItemFunc = FindUField<UFunction>(UMapExtensionsLibrary::StaticClass(), TEXT("Map_RemoveSetItem"));
	    if (!RemoveSetItemFunc)
	    {
	        // 使用 Warning 而非 Error：与项目约定一致，避免触发 EdGraphNode.h:563 断言崩溃
	        Context.MessageLog.Warning(*FString::Printf(TEXT("映射节点编译失败：在 UMapExtensionsLibrary 中未找到函数 %s。"), TEXT("Map_RemoveSetItem")), Node);
	        return;
	    }
	    ...
	    MapRemoveStmt.FunctionToCall = RemoveSetItemFunc;
...
class FNodeHandlingFunctor* UK2Node_MapRemoveSetItem::CreateNodeHandler(class FKismetCompilerContext& CompilerContext) const
{
	return new FKCHandler_MapRemoveSetItem(CompilerContext);
}
...
void UK2Node_MapRemoveSetItem::GetMenuActions(FBlueprintActionDatabaseRegistrar& ActionRegistrar) const
{
    K2NodeHelpers::RegisterNode<UK2Node_MapRemoveSetItem>(ActionRegistrar);
}

void UK2Node_MapRemoveSetItem::PostReconstructNode()
{
...
void UK2Node_MapRemoveSetItem::AllocateDefaultPins()
{
    // 创建执行引脚
...
void UK2Node_MapRemoveSetItem::PinDefaultValueChanged(UEdGraphPin* Pin)
{
    Super::PinDefaultValueChanged(Pin);
    PropagatePinType();
}

void UK2Node_MapRemoveSetItem::ReconstructNode()
{
    Super::ReconstructNode();
    PropagatePinType();
}

void UK2Node_MapRemoveSetItem::PinConnectionListChanged(UEdGraphPin* Pin)
{
...
bool UK2Node_MapRemoveSetItem::IsConnectionDisallowed(const UEdGraphPin* MyPin, const UEdGraphPin* OtherPin, FString& OutReason) const
{
    // 先检查参数有效性
    if (!MyPin || !OtherPin)
    {
...
const FName UK2Node_MapRemoveSetItem::InputMapPinName(TEXT("MapPin"));
UEdGraphPin* UK2Node_MapRemoveSetItem::GetInputMapPin() const
{
	return FindPin(InputMapPinName);
}

const FName UK2Node_MapRemoveSetItem::InputKeyPinName(TEXT("KeyPin"));
UEdGraphPin* UK2Node_MapRemoveSetItem::GetInputKeyPin() const
{
	return FindPin(InputKeyPinName);
}

const FName UK2Node_MapRemoveSetItem::InputItemPinName(TEXT("ItemPin"));
UEdGraphPin* UK2Node_MapRemoveSetItem::GetInputItemPin() const
{
...
FEdGraphPinType UK2Node_MapRemoveSetItem::GetKeyPinType() const
{
...
FEdGraphPinType UK2Node_MapRemoveSetItem::GetItemPinType() const
{
    FEdGraphPinType PinType;
    PinType.PinCategory = UEdGraphSchema_K2::PC_Wildcard;
...
void UK2Node_MapRemoveSetItem::PropagatePinType()
{
    UEdGraphPin* MapPin = GetInputMapPin();
