...
UCLASS()
class XTOOLS_ENHANCEDCODEFLOW_API UECFWhileTrueExecuteBP : public UECFActionBP
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, meta = (ToolTip = "传入'true'继续'循环执行'动作，传入'false'停止执行", DisplayName = "ECF - 条件判断 (循环执行)"), Category = "XTools|ECF|流程控制")
