...
public:
    ...
    static void SamplePointsInsideStaticMeshWithBoxOptimized(
        ...
        UPARAM(DisplayName="网格间距", meta=(ClampMin="0.1", UIMin="1.0", UIMax="500.0", ForceUnits="cm")) float GridSpacing,
        UPARAM(DisplayName="噪声偏移", meta=(ClampMin="0.0", UIMin="0.0", UIMax="100.0", ForceUnits="cm")) float Noise,
        UPARAM(DisplayName="检测半径", meta=(ClampMin="0.1", UIMin="0.1", UIMax="100.0", ForceUnits="cm")) float TraceRadius,
        bool bEnableDebugDraw,
        bool bDrawOnlySuccessfulHits,
        bool bEnableBoundsCulling,
        UPARAM(DisplayName="调试持续时间", meta=(ClampMin="0.1", UIMin="0.1", UIMax="30.0", ForceUnits="s")) float DebugDrawDuration,
        // --- Outputs
        TArray<FVector>& OutPoints,
        bool& bSuccess,
        // --- Optional Input
