...
class XTOOLS_BLUEPRINTASSIST_API SBAEditDetailsMenu final : public SCompoundWidget
{
	SLATE_BEGIN_ARGS(SBAEditDetailsMenu) { }
	SLATE_END_ARGS()
	...
	virtual ~SBAEditDetailsMenu() override;
