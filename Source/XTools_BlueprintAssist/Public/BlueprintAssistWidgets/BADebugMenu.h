...
class XTOOLS_BLUEPRINTASSIST_API SBADebugMenuRow final : public SHorizontalBox
{
...
class XTOOLS_BLUEPRINTASSIST_API SBADebugMenu final : public SCompoundWidget
{
