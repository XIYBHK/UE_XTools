...
class XTOOLS_BLUEPRINTASSIST_API FBAGlobalActionsBase : public FBAActionsBase
{
public:
...
class XTOOLS_BLUEPRINTASSIST_API FBAGlobalActions final : public FBAGlobalActionsBase
{
public:
