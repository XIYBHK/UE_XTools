...
class XTOOLS_BLUEPRINTASSIST_API FBANodeActionsBase : public FBAGraphActionsBase
{
public:
...
class XTOOLS_BLUEPRINTASSIST_API FBANodeActions final : public FBANodeActionsBase
{
public:
