...
XTOOLS_BLUEPRINTASSIST_API DECLARE_LOG_CATEGORY_EXTERN(LogKnotTrackCreator, Log, All);

struct XTOOLS_BLUEPRINTASSIST_API FKnotNodeCreation
...
struct XTOOLS_BLUEPRINTASSIST_API FKnotNodeTrack
...
struct XTOOLS_BLUEPRINTASSIST_API FGroupedTracks
{
