...
struct XTOOLS_BLUEPRINTASSIST_API FPinLink
{
	UEdGraphPin* From;
	UEdGraphPin* To;
...
struct XTOOLS_BLUEPRINTASSIST_API FNodeInfo
...
struct XTOOLS_BLUEPRINTASSIST_API FFormatXInfo
...
struct XTOOLS_BLUEPRINTASSIST_API FNodeRelativeLocation
{
...
struct XTOOLS_BLUEPRINTASSIST_API FNodeRelativeMapping
{
