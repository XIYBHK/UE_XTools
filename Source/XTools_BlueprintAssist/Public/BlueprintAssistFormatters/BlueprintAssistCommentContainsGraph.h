...
struct XTOOLS_BLUEPRINTASSIST_API FBACommentContainsNode : public TSharedFromThis<FBACommentContainsNode>
{
...
struct XTOOLS_BLUEPRINTASSIST_API FBACommentContainsGraph
