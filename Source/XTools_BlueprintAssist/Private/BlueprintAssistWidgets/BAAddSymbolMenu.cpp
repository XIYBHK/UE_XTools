...
void SBAAddSymbolMenu::Construct(const FArguments& InArgs)
{
	...
	[
		...
		.InitListItems(this, &SBAAddSymbolMenu::InitListItems)
		.OnGenerateRow(this, &SBAAddSymbolMenu::CreateItemWidget)
		.OnSelectItem(this, &SBAAddSymbolMenu::SelectItem)
		.WidgetSize(GetWidgetSize())
		.MenuTitle(FString("Add Symbol"))
	];
}

void SBAAddSymbolMenu::InitListItems(TArray<TSharedPtr<FAddSymbolStruct>>& Items)
{
...
TSharedRef<ITableRow> SBAAddSymbolMenu::CreateItemWidget(TSharedPtr<FAddSymbolStruct> Item, const TSharedRef<STableViewBase>& OwnerTable) const
{
	return
...
void SBAAddSymbolMenu::SelectItem(TSharedPtr<FAddSymbolStruct> Item)
{
